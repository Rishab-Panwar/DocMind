    ...
    try:
        ...
        for uf in uploaded_files:
            ...
            if ext not in SUPPORTED_EXTENSIONS:
                ...
                continue
            # Clean file name (only alphanum, dash, underscore) and keep it in the
            # saved filename so the original document name survives as `source`
            # metadata — needed for the LLM to attribute/list which file a chunk
            # came from. A short uuid suffix keeps names unique.
