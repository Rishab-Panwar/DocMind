    ...
    def built_retriver( self,
        ...
        *,
        ...
        try:
            ...
            # from every doc instead of clustering on the densest one.
...
class DocHandler:
    ...
    def save_file(self, uploaded_file) -> str:
        try:
            ...
            allowed = {".pdf", ".docx", ".pptx", ".md", ".txt", ".xlsx", ".xls", ".csv", ".db", ".sqlite", ".sqlite3", ".json"}
...
class DocumentComparator:
    ...
    """
    ALLOWED_EXTS = {".pdf", ".docx", ".pptx", ".md", ".txt", ".xlsx", ".xls", ".csv", ".db", ".sqlite", ".sqlite3", ".json"}
